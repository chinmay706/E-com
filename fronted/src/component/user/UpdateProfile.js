...
const UpdateProfile = () => {
  ...
  return <Fragment>
    {loading? <Loading/> :(
       ...
       <div   className="w-[100vw] md:h-[80%] h-[90vh] max-w-full bg-[#f8f8f893]   flex justify-center items-center backdrop-blur-lg   md:m-[5vmax] m-0  relative top-[2.8rem]   md:static ">
         <div className=" backdrop-blur-lg xl:w-[25vw] w-[100vw] xl:h-[70vh] bg-[#f8f8f893]   h-[100vh]  border-solid border-2 border-transparent md:border-[#0000003d]    box-border overflow-hidden">
             <h2 className="text-center text-[rgba(0,0,0,0.664)] font-normal text-[2vmax] font-Roboto p-[1.3vmax] border-b border-solid border-[rgba(0,0,0,0.205)] w-[50%] m-auto ">Update Profile</h2>
         <form
