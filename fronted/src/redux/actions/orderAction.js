...
export const Myorders = ( ) => async (dispatch ) => {
  try {
    ...
    const { data } = await axios.get(`${backedurl}/api/v1/orders/me`,{  withCredentials: true, });
...
export const getAllorders = ( ) => async (dispatch ) => {
  try {
    ...
    const { data } = await axios.get(`${backedurl}/api/v1/admin/orders`,{  withCredentials: true, });
...
export const getorderDetails = ( id) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(`${backedurl}/api/v1/order/${id}`,{  withCredentials: true, });
...
export const deleteOrder = (id) => async (dispatch ) => {
  try {
    ...
    const { data } = await axios.delete(`${backedurl}/api/v1/admin/order/${id}` ,{  withCredentials: true, } );
